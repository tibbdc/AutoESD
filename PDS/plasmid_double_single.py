...
def generate_visualize_file(key1,dict_input_seq,plasmidseq,screeningmarker_seq,config,dict_left_primer,dict_right_primer,dict_uha,dict_dha,dict_screeningmarker,dict_verify1,dict_verify2,fsave,workdir,dict_insert={},screening_maker_removal=None):
    """
    Arguments:
        key1[str]: seq id
        dict_input_seq[dict]: {
...
def design_process(input_file_path,screeningmarker_file_path,workdir,ref_genome,config,plasmid_file_path,assigned_tp1_seq=None,screening_maker_removal=None):
    ...
    headers = ['seqid','ref','alt',"manipulation","primer-1","primer-2","primer-3","primer-4","primer-5","primer-6","primer-7","primer-8","test-primer-1","test-primer-2","test-primer-3","test-primer-4","strand","geneid","mutation_pos_index","name",]
