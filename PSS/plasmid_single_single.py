...
def design_process(input_file_path,plasmid_file_path,workdir,ref_genome,config):
    ...
    headers = ['seqid','ref','alt',"manipulation","primer-1","primer-2","primer-3","primer-4","primer-5","primer-6","test-primer-1","test-primer-2","test-primer-3","strand","geneid","mutation_pos_index","name",]
